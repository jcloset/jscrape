...
# Twitter scraper function with rate limit handling
def twitter_scraper():
    ...
    try:
        tweets = client.search_recent_tweets(query="findom", max_results=10)
        ...
        for tweet in tweets.data:
            ...
            time.sleep(10)  # Wait 10 seconds between processing tweets to avoid hitting rate limits
    except tweepy.errors.TooManyRequests:
        print("❌ Error: 429 Too Many Requests - Waiting 15 minutes...")
        time.sleep(15 * 60)

# Run the Twitter scraper function
twitter_scraper()
